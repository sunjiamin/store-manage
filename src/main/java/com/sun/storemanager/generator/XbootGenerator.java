package com.sun.storemanager.generator;

import com.sun.storemanager.generator.bean.EntityOfEntity;
...
public class XbootGenerator {
     ...
     * 建议仅需修改
     */
    private static final String author = "sunjiamin";
     ...
     * 实体类对应包
     */
    private static final String entityPackage = "com.sun.storemanager.entity";

    /**
     * dao对应包
     */
    private static final String daoPackage = "com.sun.storemanager.dao";

    /**
     * service对应包
     */
    private static final String servicePackage = "com.sun.storemanager.service";

    /**
     * serviceImpl对应包
     */
    private static final String serviceImplPackage = "com.sun.storemanager.serviceimpl";

    /**
     * controller对应包
     */
    private static final String controllerPackage = "com.sun.storemanager.controller";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        //创建文件
        String entityFileUrl = System.getProperty("user.dir")+"/src/main/java/com/sun/storemanager/entity/"+className+".java";
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir")+"/src/main/java/com/sun/storemanager/dao/"+className+"Dao.java";
        ...
        //创建文件
        String serviceFileUrl = System.getProperty("user.dir")+"/src/main/java/com/sun/storemanager/service/"+className+"Service.java";
        ...
        //创建文件
        String serviceImplFileUrl = System.getProperty("user.dir")+"/src/main/java/com/sun/storemanager/serviceimpl/"+className+"ServiceImpl.java";
        ...
        //创建文件
        String controllerFileUrl = System.getProperty("user.dir")+"/src/main/java/com/sun/storemanager/controller/"+className+"Controller.java";
